...
) : BaseUseCase<Flow<ApiResponse<HeroModel, ErrorResponse>>, GetHero.Params>() {

    override suspend fun execute(params: Params): Flow<ApiResponse<HeroModel, ErrorResponse>> {
