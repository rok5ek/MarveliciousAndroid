...
) : BaseUseCase<Flow<ApiResponse<List<SeriesModel>, ErrorResponse>>, GetHeroSeries.Params>() {

    override suspend fun execute(params: Params): Flow<ApiResponse<List<SeriesModel>, ErrorResponse>> {
