...
) : BaseUseCase<Flow<ApiResponse<List<ComicModel>, ErrorResponse>>, GetHeroComics.Params>() {

    override suspend fun execute(params: Params): Flow<ApiResponse<List<ComicModel>, ErrorResponse>> {
